...
// NOTE: THIS IS A PATCHED CLASS, REMOVE ONCE FIXED:
// https://github.com/wpilibsuite/allwpilib/pull/5801
...
public final class StructBuffer<T> {
  ...
  /**
   * Ensures sufficient buffer space is available for the given number of
   * elements.
   *
  ...
  /**
   * Serializes a value to a ByteBuffer. The returned ByteBuffer is a direct byte
   * buffer with the
  ...
  /**
   * Serializes a collection of values to a ByteBuffer. The returned ByteBuffer is
   * a direct byte
  ...
  /**
   * Serializes an array of values to a ByteBuffer. The returned ByteBuffer is a
   * direct byte buffer
  ...
  /**
   * Deserializes an array of values from a byte array, creating an array of new
   * objects.
   *
   * @param buf   byte array
   * @param start starting location within byte array
  ...
  /**
   * Deserializes an array of values from a ByteBuffer, creating an array of new
   * objects.
   *
   * @param buf byte buffer
   * @return new object array
