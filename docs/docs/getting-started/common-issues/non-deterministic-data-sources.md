...
# Non-Deterministic Data Sources {#non-deterministic-data-sources}
...
- Use of raw FPGA timestamps, such as `Timer.getMonotonicTimestamp()`. Use `Timer.getTimestamp()` instead.
