...
public class LoggedMechanism2dTest {
  ...
  public void TestSimpleArmFK() {
    ...
    LoggedMechanismLigament2d ligamentBase =
        mechRoot.append(new LoggedMechanismLigament2d("base", Meters.of(0.5), Degrees.of(90)));
    LoggedMechanismLigament2d ligamentArm =
        ligamentBase.append(new LoggedMechanismLigament2d("arm", Meters.of(0.5), Degrees.of(0)));
  ...
  public void TestSimpleBentArmFK() {
    ...
    LoggedMechanismLigament2d ligamentBase =
        mechRoot.append(new LoggedMechanismLigament2d("base", Meters.of(0.5), Degrees.of(90)));
    LoggedMechanismLigament2d ligamentArm =
        ligamentBase.append(new LoggedMechanismLigament2d("arm", Meters.of(0.5), Degrees.of(-90)));
  ...
  public void TestThreeSegmentFK() {
    ...
    LoggedMechanismLigament2d ligamentGripper =
        ligamentArm.append(
  ...
  public void TestSplitRoot() {
    ...
    LoggedMechanismLigament2d ligamentGripper =
        ligamentArm.append(
            new LoggedMechanismLigament2d("gripper", Meters.of(0.2), Degrees.of(90)));
    // back forwards parallel to the ground
    LoggedMechanismLigament2d ligamentArm2 =
        ligamentBase.append(new LoggedMechanismLigament2d("arm2", Meters.of(0.5), Degrees.of(-45)));
    // and again back upwards
    LoggedMechanismLigament2d ligamentGripper2 =
        ligamentArm2.append(
