...
public class LoggedMechanism2dTest {
    ...
    public void TestSimpleArmFK() {
        ...
        LoggedMechanismLigament2d ligamentBase = mechRoot
                .append(new LoggedMechanismLigament2d("base", Meters.of(0.5), Degrees.of(90)));
        LoggedMechanismLigament2d ligamentArm = ligamentBase
                .append(new LoggedMechanismLigament2d("arm", Meters.of(0.5), Degrees.of(0)));
        ...
        Pose3d endeff = lastPose.transformBy(new Transform3d(ligamentArm.getLength(), 0, 0, Rotation3d.kZero));
    ...
    public void TestSimpleBentArmFK() {
        ...
        LoggedMechanismLigament2d ligamentBase = mechRoot
                .append(new LoggedMechanismLigament2d("base", Meters.of(0.5), Degrees.of(90)));
        LoggedMechanismLigament2d ligamentArm = ligamentBase
                .append(new LoggedMechanismLigament2d("arm", Meters.of(0.5), Degrees.of(-90)));
    ...
    public void TestThreeSegmentFK() {
        ...
        assertEquals(0, poses.get(1).getTranslation().getDistance(new Translation3d(0, 0, 0.5)), DELTA);
        assertEquals(
                0, poses.get(2).getTranslation().getDistance(new Translation3d(0.5, 0, 0.5)), DELTA);

        // Test EndEffector location
        Pose3d lastPose = poses.get(poses.size() - 1);
        Pose3d endeff = lastPose.transformBy(new Transform3d(ligamentGripper.getLength(), 0, 0, Rotation3d.kZero));
    ...
    public void TestSplitRoot() {
        ...
        LoggedMechanismLigament2d ligamentGripper = ligamentArm.append(
                new LoggedMechanismLigament2d("gripper", Meters.of(0.2), Degrees.of(90)));
        // back forwards parallel to the ground
        LoggedMechanismLigament2d ligamentArm2 = ligamentBase
                .append(new LoggedMechanismLigament2d("arm2", Meters.of(0.5), Degrees.of(-45)));
        // and again back upwards
        ...
        assertEquals(
                0, poses.get(2).getTranslation().getDistance(new Translation3d(0.5, 0, 0.5)), DELTA);
        assertEquals(
                0, poses.get(3).getTranslation().getDistance(new Translation3d(0.0, 0, 0.5)), DELTA);
        assertEquals(
                0,
                poses
                        .get(4)
                        .getTranslation()
                        .getDistance(new Translation3d(0.35355339059, 0, 0.5 + 0.35355339059)),
                DELTA);
        ...
        endeff = lastPose.transformBy(new Transform3d(ligamentGripper2.getLength(), 0, 0, Rotation3d.kZero));
        assertEquals(
                0,
                endeff
                        .getTranslation()
                        .getDistance(new Translation3d(0.35355339059, 0, 0.7 + 0.35355339059)),
                DELTA);
