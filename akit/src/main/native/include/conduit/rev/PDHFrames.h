 ...
 */
int PDH_set_switch_channel_pack(uint8_t *dst_p,
		const struct PDH_set_switch_channel_t *src_p, size_t size);
 ...
 */
int PDH_set_switch_channel_unpack(struct PDH_set_switch_channel_t *dst_p,
 ...
 * @return Size of packed data, or negative error code.
 */
int PDH_status_0_pack(uint8_t *dst_p, const struct PDH_status_0_t *src_p,
		size_t size);
 ...
 * @return zero(0) or negative error code.
 */
int PDH_status_0_unpack(struct PDH_status_0_t *dst_p, const uint8_t *src_p,
		size_t size);
 ...
 * @return Size of packed data, or negative error code.
 */
int PDH_status_1_pack(uint8_t *dst_p, const struct PDH_status_1_t *src_p,
		size_t size);
 ...
 * @return zero(0) or negative error code.
 */
int PDH_status_1_unpack(struct PDH_status_1_t *dst_p, const uint8_t *src_p,
		size_t size);
 ...
 * @return Size of packed data, or negative error code.
 */
int PDH_status_2_pack(uint8_t *dst_p, const struct PDH_status_2_t *src_p,
		size_t size);
 ...
 * @return zero(0) or negative error code.
 */
int PDH_status_2_unpack(struct PDH_status_2_t *dst_p, const uint8_t *src_p,
		size_t size);
 ...
 * @return Size of packed data, or negative error code.
 */
int PDH_status_3_pack(uint8_t *dst_p, const struct PDH_status_3_t *src_p,
		size_t size);
 ...
 * @return zero(0) or negative error code.
 */
int PDH_status_3_unpack(struct PDH_status_3_t *dst_p, const uint8_t *src_p,
		size_t size);
 ...
 * @return Size of packed data, or negative error code.
 */
int PDH_status_4_pack(uint8_t *dst_p, const struct PDH_status_4_t *src_p,
		size_t size);
 ...
 * @return zero(0) or negative error code.
 */
int PDH_status_4_unpack(struct PDH_status_4_t *dst_p, const uint8_t *src_p,
		size_t size);
 ...
 * @return Size of packed data, or negative error code.
 */
int PDH_clear_faults_pack(uint8_t *dst_p,
		const struct PDH_clear_faults_t *src_p, size_t size);
 ...
 * @return zero(0) or negative error code.
 */
int PDH_clear_faults_unpack(struct PDH_clear_faults_t *dst_p,
		const uint8_t *src_p, size_t size);
 ...
 * @return Size of packed data, or negative error code.
 */
int PDH_version_pack(uint8_t *dst_p, const struct PDH_version_t *src_p,
		size_t size);
 ...
 * @return zero(0) or negative error code.
 */
int PDH_version_unpack(struct PDH_version_t *dst_p, const uint8_t *src_p,
		size_t size);
