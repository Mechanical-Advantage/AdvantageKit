...
class WPILOGWriter : public LogDataReceiver {
    ...
    WPILOGWriter(std::string path) : WPILOGWriter{path, AdvantageScopeOpenBehavior::AUTO} {}

    WPILOGWriter(AdvantageScopeOpenBehavior openBehavior) : WPILOGWriter{std::string{frc::RobotBase::IsSimulation() ? DEFAULT_PATH_SIM : DEFAULT_PATH_RIO}, openBehavior} {}

    WPILOGWriter() : WPILOGWriter{std::string{frc::RobotBase::IsSimulation() ? DEFAULT_PATH_SIM : DEFAULT_PATH_RIO}, AdvantageScopeOpenBehavior::AUTO} {}
    ...
    static constexpr std::string_view ADVANTAGESCOPE_FILE_NAME = "ascope-log-path.txt";
