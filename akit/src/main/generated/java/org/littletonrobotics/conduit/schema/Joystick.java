...
public final class Joystick extends Struct {
  ...
  public int povCount() { return bb.get(bb_pos + 352) & 0xFF; }
  public void mutatePovCount(int pov_count) { bb.put(bb_pos + 352, (byte) pov_count); }
  ...
  public static int createJoystick(FlatBufferBuilder builder, int[] name, int type, int supportedOutputs, short axisCount, float[] axisValues, short[] axisRaw, long buttonsAvailable, long buttons, int povCount, int[] povValues, boolean isGamepad, int touchpadCount, int[] touchpads_fingerCount, int[][] touchpads_fingers_down, float[][] touchpads_fingers_x, float[][] touchpads_fingers_y) {
    builder.prep(8, 424);
    builder.pad(4);
